...
puts 'it worked!'
=======
Concert.create!(artist_id: 3, venue_id: 1)
Concert.create!(artist_id: 1, venue_id: 5)
Concert.create!(artist_id: 4, venue_id: 2)
Concert.create!(artist_id: 1, venue_id: 4)
Concert.create!(artist_id: 4, venue_id: 3)
Concert.create!(artist_id: 6, venue_id: 5)
Concert.create!(artist_id: 5, venue_id: 1)
Concert.create!(artist_id: 2, venue_id: 2)

Ticket.create!(price: 60, fan_id: 1, concert_id: 1)
Ticket.create!(price: 100, fan_id: 5, concert_id: 1)
Ticket.create!(price: 120, fan_id: 3, concert_id: 1)
Ticket.create!(price: 80, fan_id: 6, concert_id: 1)
Ticket.create!(price: 30, fan_id: 2, concert_id: 1)
Ticket.create!(price: 10, fan_id: 4, concert_id: 1)
Ticket.create!(price: 45, fan_id: 1, concert_id: 1)
Ticket.create!(price: 180, fan_id: 6, concert_id: 1)
Ticket.create!(price: 80, fan_id: 5, concert_id: 1)
>>>>>>> tj1
